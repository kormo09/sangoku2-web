...
export function blockAddEventListener(
  ...
  target.addEventListener = function (event, handler) {
    ...
    return originAddEventListener.apply(this, arguments as unknown as Parameters<HasAddEventListener["addEventListener"]>); // eslint-disable-line prefer-rest-params
  };
}
